module lane_emden_solver
   ...
   ! Needed to add the null_solout as mesa-26.04.1/num/pulic/num_lib.f90 has private and they did not add
	...
	subroutine my_null_solout(nr, xold, x, n, y, rwork, iwork, interp_y, lrpar, rpar, lipar, ipar, irtrn)
	...
	subroutine test_cash_karp(show_all)
		implicit none
		 ...
		 call dopri5( &
               ...
               h_le,max_step_size_le,max_steps_le, &
               rtol_le,atol_le,itol_le, &
               my_null_solout,iout_le,work_le,lwork_le,iwork_le,liwork_le, &
               lrpar_le,rpar_le,lipar_le,ipar_le,lout_le,idid_le)
